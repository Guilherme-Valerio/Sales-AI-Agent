...
remote_app = agent_engines.create(
    ...
    requirements=[
        "google-adk>=1.21.0",
        "google-cloud-aiplatform[adk,agent_engines]>=1.21.0","google-genai>=0.5.0",
        "python-dotenv>=1.0.1",
        "cloudpickle>=3.0.0",
        "pydantic>=2.6.0",
        "google-auth>=2.25.0",
...
"""
agent_engine = vertexai.agent_engines.get('projects/243890394709/locations/us-central1/reasoningEngines/2448160495778136064')

AGENT_RESOURCE_NAME = (
    f"projects/243890394709/locations/us-central1/reasoningEngines/2448160495778136064"
)

USER_ID = "gui.svalerio2005@gmail.com"
